...
// 	g.Engine = engine.MakeEngine(&g.World)
// 
...
// 	}
// 
// 	for ev, ok := ctx.Events.Dequeue(); ok; ev, ok = ctx.Events.Dequeue() {
...
// 				g.renderableCard1.Transform.RotateX(0.25 * math.Pi * ctx.Dtf)
...
// 	}
// 
// 	// Pass events over for state.
// 	ctx.Events = &stateEvents
// 	g.State.Tick(ctx)
// 
// 	g.Engine.Tick(ctx)
// 	return true
